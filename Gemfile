...
#gem 'turbolinks', '~> 5' #removed b/c it causes lots of javaxcript problems
...
# Only used during development and testing b/c heroku doesn't like this gem. Cant use for production

group :production do
  gem 'pg'
  gem 'rails_12factor'
end
# Used for production b/c Heroku likes this gem
